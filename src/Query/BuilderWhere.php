...
trait BuilderWhere
{
    ...
    {
        return $this->whereBetweenSymmetric($column, $values, 'or');
    }
    ...
    {
        return $this->whereNotBetweenSymmetric($column, $values, 'or');
    }
     ...
     * @param 'and'|'or' $boolean
     */
    public function whereNotBetweenSymmetric($column, iterable $values, string $boolean = 'and'): static
    {
        return $this->whereBetweenSymmetric($column, $values, $boolean, true);
    }
